            ...
            <div className="flex flex-col justify-between h-full">
              <div className="mb-4 px-6 mt-6">
                <div className="flex justify-between items-center mb-6 pb-2">
                  <h2 className="text-white/70 text-xl">Custom Metadata</h2>
                  <div className="flex items-center">
                    <div className="h-1 bg-black w-8 rounded-lg"></div>
                    <span className="ml-2 text-white/70 text-sm">Tailored for You</span>
                  </div>
                </div>
              ...
              <div className="text-left p-6 mt-4">
                <h1 className="text-white text-2xl font-bold mb-2">AI-Powered Metadata</h1>
                <p className="text-white/70 text-lg">Leverage OpenAI's advanced language models to generate intelligent, context-aware SEO metadata.</p>
              </div>
            </div>
          </CardWithEffect>
            ...
            <CardWithEffect>
              <div className="flex flex-col justify-center h-full">
                ...
                <div className="text-left p-6">
                  <h1 className="text-white text-2xl font-bold mb-2">Next.js Integration</h1>
                  <p className="text-white/70 text-lg">Seamlessly integrate with Next.js projects for automatic metadata injection and optimization.</p>
                </div>
              </div>
            </CardWithEffect>
            <CardWithEffect>
              <div className="flex flex-col justify-center h-full">
                <LogoBeam />
                <div className="text-left p-6">
                  <h1 className="text-white text-2xl font-bold mb-2">Internationalization Support</h1>
                  <p className="text-white/70 text-lg">SSupport for multiple languages and regions, ensuring global SEO optimization.</p>
                </div>
              </div>
            </CardWithEffect>
          </div>
